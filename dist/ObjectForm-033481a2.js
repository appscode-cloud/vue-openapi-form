import { m as createNonEnumerableProperty, $, v as model } from './model-a2dbe01c.js';
import { w as wellKnownSymbol, r as require$$0, v as validation } from './validation-de903b65.js';
...
import { c as create } from './object-create-e86df5b7.js';
...
var script = {
  ...
  components: {
    "vue-openapi-form": function vueOpenapiForm() {
      return import('./VueOpenapiForm-66b0bcce.js');
    },
    "array-input": function arrayInput() {
      return import('./ArrayInput-7787d928.js');
    },
    "simple-input": function simpleInput() {
      return import('./SimpleInput-900e365c.js');
    },
    "key-value-pairs": function keyValuePairs() {
      return import('./KeyValuePairs-b6d2a4f2.js');
    }
  },
  methods: {
