...
function isEqual(lhs, rhs) {
    ...
    if (isObject$3(lhs) && isObject$3(rhs)) {
...
function _getRuleTargets(field, ruleSchema, ruleName) {
    ...
    if (!Array.isArray(ruleConfig) && isObject$3(ruleConfig)) {
...
function onRenderUpdate(vm, value) {
    ...
    vm.validateSilent().then(vm.immediate || vm.flags.validated ? vm.applyResult : identity$1);
}
...
var __vue_render__$3 = function() {
  ...
  return _c("div", [
    _vm.valid
      ? _c("span", { staticClass: "icon is-small is-right is-success" }, [
          _c("i", { staticClass: "fa fa-check" })
        ])
      : _vm._e(),
    _vm._v(" "),
    _vm.invalid
      ? _c("span", { staticClass: "icon is-small is-right is-warning" }, [
...
// https://tc39.github.io/ecma262/#sec-object.prototype.tostring
if (objectToString$1 !== ObjectPrototype$2.toString) {
  redefine(ObjectPrototype$2, 'toString', objectToString$1, { unsafe: true });
}
...
var script$6 = {
  ...
  methods: {
    ...
    addNewValue: function addNewValue() {
      ...
      return regenerator.async(function addNewValue$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return regenerator.awrap(this.$refs[observerRef].validate());
...
var arguments$1 = arguments;
 for (var i = 1; i < arguments.length; i++) { var source = arguments$1[i] != null ? arguments$1[i] : {}; if (i % 2) { ownKeys$3(source, true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$3(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
var script$7 = {
  props: {
    schema: {
      type: Object,
  ...
  methods: {
    ...
    addProp: function addProp() {
      var observerRef, isValid;
      return regenerator.async(function addProp$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
