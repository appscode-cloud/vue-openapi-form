...
var tabs = {
  ...
  components: {
    tabs: function tabs() {
      return import('./Tabs-0c392683.js');
...
for (var COLLECTION_NAME$1 in domIterables$1) {
  ...
  if (CollectionPrototype$1 && !CollectionPrototype$1[TO_STRING_TAG$5]) {
    createNonEnumerableProperty$1(CollectionPrototype$1, TO_STRING_TAG$5, COLLECTION_NAME$1);
  }
...
var script$3 = {
  ...
  components: {
    VueOpenapiForm: __vue_component__$6,
    ArrayInput: __vue_component__$4,
    SimpleInput: __vue_component__$2,
    KeyValuePairs: __vue_component__$3
  },
  data: function data() {
    return {
      newData: null,
...
var script$6 = {
  ...
  components: {
    ObjectForm: __vue_component__$5
  }
};
...
function install(Vue) {
  ...
  Vue.component("VueOpenapiForm", __vue_component__$6);
