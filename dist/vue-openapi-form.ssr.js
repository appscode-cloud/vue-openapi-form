...
var recurse = function recurse(schema, title) {
  ...
  if (schema.type === "object") {
    ...
    try {
      if (schema.properties) {
        Object.keys(schema.properties).forEach(function (prop) {
          ...
          newProperties = Object.assign({}, _objectSpread$3({}, newProperties), _defineProperty({}, "".concat(prop), _objectSpread$3({}, recurse(schema.properties[prop], title))));
        }); // assign new properties to newSchema

        newSchema = Object.assign({}, _objectSpread$3({}, newSchema), {
          properties: _objectSpread$3({}, newProperties)
        });
          ...
          newSchema.additionalProperties = Object.assign({}, _objectSpread$3({}, schema.additionalProperties), {
            title: "Value",
            ui: {
              tag: "input",
              type: "text"
    ...
    var _title = "";
    newItems = Object.assign({}, _objectSpread$3({}, newItems), _objectSpread$3({}, recurse(schema.items, _title))); // assign new items to newSchema

    newSchema = Object.assign({}, _objectSpread$3({}, newSchema), {
      items: _objectSpread$3({}, newItems)
    });
  } else {
    var type = "";
